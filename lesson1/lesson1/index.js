...
let MyCity="Baranovichi";
let MyCountry="Belarus";
let Population="174000";
let Stadium=true;
console.log('город:',MyCity);
console.log('страна:',MyCountry);
console.log('численность:',Population);
console.log('Есть стадион:',Stadium);
...
let Length_A=40;
let Length_B=70;
let Square=Length_A*Length_B;
console.log('Площадь равна=', Square, 'см2')
...
console.log('На расстоянии ',distance,'км')
